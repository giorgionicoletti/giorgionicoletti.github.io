...
With Antonio Celani (ICTP, Italy), Daniel M. Busiello (MPIPKS, Germany) and many other collaborators, I am currently working on understanding **how biological and artificial agents process information and make decisions** in complex and stochastic environments. We are seeking universal principles that can be applied across different scales, from biochemical to neural networks, exploiting ideas from Information Theory and tools from machine learning.
...
{% include section-head.html title="Metapopulation Models for Spatial Ecology" target="ecology" %}
<div id="ecology" class="section-body prose" markdown="1">

With Amos Maritan (University of Padova), Andrea Rinaldo (EPFL) and Prajwal Padmanabha (University of Lausanne) I am studying **spatial metapopulation models** through the lenses of Statistical Physics. By studying ecological systems in arbitrary network topologies, we seek to understand how dispersal affects **survival, coexistence, and dynamics of ecological metacommunities**.
...
{% include section-head.html title="Modeling and Data Analysis for Neuroscience" target="neuro" %}
<div id="neuro" class="section-body prose" markdown="1">

With Samir Suweis (University of Padova) and several experimental collaborators, I have been studying since the beginning of my PhD the **emergence of critical signatures in neural activity** and how tools from Statistical Physics can be used to understand the dynamics of the brain.
